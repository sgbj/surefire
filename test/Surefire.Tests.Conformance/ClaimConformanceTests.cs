...
public abstract class ClaimConformanceTests : StoreConformanceBase
{
    ...
    public async Task Claim_RespectsJobFilter()
    {
        ...
        await Store.UpsertJobsAsync([jobA], ct);
        await Store.UpsertJobsAsync([jobB], ct);
    ...
    public async Task Claim_RespectsQueueFilter()
    {
        ...
        job.Queue = "fast";
        await Store.UpsertJobsAsync([job], ct);
        await Store.UpsertQueuesAsync([new() { Name = "fast" }], ct);
    ...
    public async Task Claim_RespectsQueueMaxConcurrency()
    {
        ...
        await Store.UpsertQueuesAsync([new() { Name = queueName, MaxConcurrency = 1 }], ct);
    ...
    public async Task Claim_RespectsQueuePriority()
    {
        ...
        await Store.UpsertQueuesAsync([new() { Name = highQueueName, Priority = 10 }], ct);
        await Store.UpsertQueuesAsync([new() { Name = lowQueueName, Priority = 0 }], ct);
        ...
        await Store.UpsertJobsAsync([jobHigh], ct);
        await Store.UpsertJobsAsync([jobLow], ct);
    ...
    public async Task Claim_RespectsQueuePriorityChange_ExistingPendingRuns()
    {
        ...
        await Store.UpsertQueuesAsync([new() { Name = queueA, Priority = 0 }], ct);
        await Store.UpsertQueuesAsync([new() { Name = queueB, Priority = 10 }], ct);
    ...
    public async Task Claim_EqualQueuePriority_GlobalRunPriorityOrdering()
    {
        ...
        await Store.UpsertQueuesAsync([new() { Name = queueA, Priority = 10 }], ct);
        await Store.UpsertQueuesAsync([new() { Name = queueB, Priority = 10 }], ct);
