...
///     (<see cref="JobStatus.Failed" /> or <see cref="JobStatus.Canceled" />). Callers that need
...
public sealed class JobRunException : Exception
{
    ...
    /// <param name="status">The terminal status, either <see cref="JobStatus.Failed" /> or <see cref="JobStatus.Canceled" />.</param>
