...
/// <param name="Canceled">The number of runs that were canceled.</param>
public readonly record struct BatchCounters(int Total, int Succeeded, int Failed, int Canceled);
